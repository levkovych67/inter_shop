...
<div class="container col-xs-6 col-xs-offset-3" ng-controller="RegisterAdminCtrl">
    <br>
    ...
    <form class="form-horizontal jumbotron white col-xs-12 ">
        <p class="text-center">Register new admin</p>
...
<script src="/resources/js/register-admin-ctrl.js"></script>
